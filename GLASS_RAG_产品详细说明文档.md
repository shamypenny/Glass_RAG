...
本文档目标是描述一份基于原型图的可用于产品讨论、方案评审和研发对齐的产品说明文档。

说明：

- 原型图中核心语义较明确，包含 `Glass-RAG`、`RAG设计图`、`文档收集`、`OCR/解析/多模态`、`切块/向量化`、`Query意图识别`、`Qwen路由`、`RAG检索重排`、`数据上传`、`文献/专利/技术报告`、`行规/行业信息`、`数据隐私`、`权限/合规处理` 等要素。
